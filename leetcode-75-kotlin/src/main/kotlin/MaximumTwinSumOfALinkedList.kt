 ...
 * 1 <= Node.val <= 10^5
 * @see <a href="https://leetcode.com/problems/maximum-twin-sum-of-a-linked-list/">LeetCode</a>
 *
 * Example:
 * var li = ListNode(5)
 * var v = li.`val`
...
fun pairSum(head: ListNode?): Int {
    ...
    var left = previousPointer
    var right = currentPointer
    var maxTwinSum = 0
    while (left != null && right != null) {
        val twinSum = left.`val` + right.`val`
